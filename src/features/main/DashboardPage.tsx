  ...
  return (
    <div className="flex flex-col justify-center w-screen">
      <div className="text-center">
        <h1 className="text-6xl font-bold text-white">Candelaria Valle.</h1>
        <p className="text-xl mb-8 text-white">Encuentra información aquí.</p>
      </div>

      <div className="ml-20 mr-20 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <img
            src="/src/assets/images/HotelCandelaria.jpg"
            alt="Hoteles"
            className="w-full h-48 object-cover rounded-md mb-4"
          />
          <p className="text-xl font-semibold text-purple-600 hover:text-purple-800">
